...
from openprompt.data_utils.text_classification_dataset import AgnewsProcessor, DBpediaProcessor, ImdbProcessor, \
    AmazonProcessor, AclProcessor, THUProcessor
import torch
...
parser.add_argument("--model_name_or_path", default='/home/ubuntu/user_lzl/prompt/model')
...
parser.add_argument("--batch_s", type=int)
...
if args.dataset == "agnews":
    ...
    dataset['train'] = AclProcessor().get_train_examples("./datasets/TextClassification/acl/")
    dataset['test'] = AclProcessor().get_test_examples("./datasets/TextClassification/acl/")
    class_labels =AclProcessor().get_labels()
    scriptsbase = "TextClassification/acl"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = 32
elif args.dataset == "newsgroups1":
    dataset['train'] = New_1Processor().get_train_examples("./datasets/TextClassification/newsgroups1/")
    dataset['test'] = New_1Processor().get_test_examples("./datasets/TextClassification/newsgroups1/")
    class_labels =New_1Processor().get_labels()
    ...
    dataset['train'] = New_2Processor().get_train_examples("./datasets/TextClassification/newsgroups2/")
    dataset['test'] = New_2Processor().get_test_examples("./datasets/TextClassification/newsgroups2/")
    class_labels =New_2Processor().get_labels()
    ...
    dataset['train'] = New_3Processor().get_train_examples("./datasets/TextClassification/newsgroups3/")
    dataset['test'] = New_3Processor().get_test_examples("./datasets/TextClassification/newsgroups3/")
    class_labels =New_3Processor().get_labels()
    ...
    dataset['train'] = New_1Processor().get_train_examples("./datasets/TextClassification/newsgroups4/")
    dataset['test'] = New_1Processor().get_test_examples("./datasets/TextClassification/newsgroups4/")
    class_labels =New_1Processor().get_labels()
    ...
    dataset['train'] = New_2Processor().get_train_examples("./datasets/TextClassification/newsgroups5/")
    dataset['test'] = New_2Processor().get_test_examples("./datasets/TextClassification/newsgroups5/")
    class_labels =New_2Processor().get_labels()
    ...
    dataset['train'] = New_3Processor().get_train_examples("./datasets/TextClassification/newsgroups6/")
    dataset['test'] = New_3Processor().get_test_examples("./datasets/TextClassification/newsgroups6/")
    class_labels =New_3Processor().get_labels()
    ...
    dataset['train'] = AmazonEProcessor().get_train_examples("./datasets/TextClassification/amazon_d-e/")
    dataset['test'] = AmazonEProcessor().get_test_examples("./datasets/TextClassification/amazon_d-e/")
    class_labels = AmazonEProcessor().get_labels()
    ...
    dataset['train'] = AmazonEProcessor().get_train_examples("./datasets/TextClassification/amazon_e-b/")
    dataset['test'] = AmazonEProcessor().get_test_examples("./datasets/TextClassification/amazon_e-b/")
    class_labels = AmazonEProcessor().get_labels()
    ...
    batch_s = args.batch_s
    max_epochs = args.max_epochs
elif args.dataset == "yelp_hotel":
    dataset['train'] = YELPProcessor().get_train_examples("./datasets/TextClassification/yelp_hotel/")
    dataset['test'] = YELPProcessor().get_test_examples("./datasets/TextClassification/yelp_hotel/")
    class_labels = YELPProcessor().get_labels()
    scriptsbase = "TextClassification/yelp_hotel"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_s
    ...
    dataset['train'] = TmnProcessor().get_train_examples("./datasets/TextClassification/tmn/")
    dataset['test'] = TmnProcessor().get_test_examples("./datasets/TextClassification/tmn/")
    class_labels = TmnProcessor().get_labels()
    scriptsbase = "TextClassification/tmn"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = 32
elif args.dataset == "spam":
    dataset['train'] = SpamProcessor().get_train_examples("./datasets/TextClassification/spam/")
    dataset['test'] = SpamProcessor().get_test_examples("./datasets/TextClassification/spam/")
    class_labels =SpamProcessor().get_labels()
    scriptsbase = "TextClassification/spam"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = 30
    ...
    dataset['train'] = THUProcessor().get_train_examples("./datasets/TextClassification/THU/")
    dataset['test'] = THUProcessor().get_test_examples("./datasets/TextClassification/THU/")
    class_labels = THUProcessor().get_labels()
    scriptsbase = "TextClassification/THU"
    scriptformat = "txt"
    cutoff=0
    max_seq_l = 512
    batch_s = 30
...
content_write += f"batch_s {args.batch_s}\t"
